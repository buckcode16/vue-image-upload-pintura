<template>
  <div class="grid grid-cols-2 gap-4">
    ...
    <div class="col-span-1">
      <video class="fixed top-0 left-0object-cover z-[-1]" autoplay loop muted>
        <source
          src="https://www.socialprintstudio.com/img/products/daily-calendar/new-slider/daily-calendar-2.mp4"
          type="video/mp4"
        />
      </video>
    </div>
